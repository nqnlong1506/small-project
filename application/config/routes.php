...
$route['api/user/create']["POST"] = 'Users/add_user';
$route['users/all'] = 'Users/fetch_all_users';
// $route['api/users']['GET'] = 'Users/fetch_all_users';


// User API routes
$route['api/user/register'] = 'api/user/register/register';
$route['api/user/login'] = 'api/user/login/login';
$route['api/user/list'] = 'api/user/user/list_users';
